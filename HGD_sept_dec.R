...
data_HGD_original <- read.csv2("data_HGD_sept_dec.csv", head = T, sep = ";", stringsAsFactors = T)
...
gg
#ggsave("Rplot_sept_dec/nb_data_daynight.png",gg, width = 25, height = 13)
...
gg <- gg + labs(y = "Bird_id", x = "Number of data per hour")
gg
#ggsave("Rplot/nb_data_HH_Disp.png",gg)
...
gg
ggsave("Rplot_sept_dec/Kernel/kernel_NPDC_LSCV.png",gg, width = 25, height = 13)
...
gg
ggsave("Rplot_sept_dec/Kernel/kernel_HDF_LSCV.png",gg, width = 25, height = 13)
...
#gg <- gg + scale_fill_manual(values=vec_colour)
gg
ggsave("Rplot_sept_dec/Kernel/kernel_NPDC_bird_LSCV.png",gg, width = 25, height = 13)
...
gg
ggsave("Rplot_sept_dec/Kernel/kernel_NPDC_LSCV_sup5.png",gg, width = 25, height = 13)
...
gg <- gg + labs(x="",y="",colour="Birds",title="ZST des HGD en dispersion dans les départements du Nord et du Pas-de-Calais issus des domaines vitaux (Kernel 95%)")
gg
ggsave("Rplot_sept_dec/Kernel/kernel_NPDC_LSCV_sup5_complete.png",gg, width = 25, height = 13)
...
gg <- gg + labs(x="",y="",colour="Birds",title="ZST des HGD en dispersion dans les départements du Nord et du Pas-de-Calais issus des domaines vitaux (Kernel 95%)")
gg
ggsave("Rplot_sept_dec/Kernel/kernel_NPDC_bird_LSCV_sup5.png",gg, width = 25, height = 13)
