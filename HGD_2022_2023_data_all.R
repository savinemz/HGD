...
data_HGD_original <- read.csv2("data_HGD_all.csv", head = T, sep = ";", stringsAsFactors = T)
data_HGD_original <- data_HGD_original %>% relocate(hdop, .after = solar_I_mA)
...
data_HGD <- data_HGD[,-c(3,26,27,28,29)]
str(data_HGD)
